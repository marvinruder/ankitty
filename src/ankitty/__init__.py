...
kitten_reinforcer = KittenReinforcer(main_window, config)

main_window._kitten_reinforcer = kitten_reinforcer  # type: ignore[attr-defined]

initialize_views(kitten_reinforcer)
